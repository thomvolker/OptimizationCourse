...
Chapter 2 is the first chapter that actually entails exercises. 

## Exercises (2.7 in the notes)

__1. Consider the multinomial likelihood in @eq-multin for a model (for a two-way contingency table) assuming independence. Can you simplify the likelihood?__
$$
...
__2. In a mixed model, optimization is carried out using the marginal likelihood (the likelihood with the random effects integrated out). Define the marginal likelihood for the one-way random effects ANOVA model.__
